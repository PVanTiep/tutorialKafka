package com.example.kafkaexample.Tiope.config;

import com.example.kafkaexample.Tiope.Message;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Message> consumerFactory() {
        ...
        jsonDeserializer.addTrustedPackages("com.example.kafkaexample.Tiope");
